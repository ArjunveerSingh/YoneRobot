...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://i.pinimg.com/originals/4a/e4/37/4ae437ae0798d38b6b10d62e7617fcfa.jpg), ɪᴍ Nozomi ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ Nozomi ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/Nozomi_Support?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="yone_"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/Nozomi_Support"
        ),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @KingArjunXY \
 Supporting isnt always financial! \
 Those who cannot provide monetary support are welcome to help us develop the bot at @KingArjunXY."""
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Nozomi*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about yone, let us know at @KingArjunXY .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
